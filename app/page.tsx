...
// Dynamically import components that use browser APIs (canvas, window) with SSR disabled
const ProductBottleScroll = dynamic(
    () => import("../components/ProductBottleScroll").then((m) => ({ default: m.ProductBottleScroll })),
    { ssr: false }
);
            ...
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    >
                        ...
                        <div className="aspect-square bg-gradient-to-br from-white/10 to-white/5 border border-white/10 rounded-3xl flex items-center justify-center p-8 backdrop-blur-sm overflow-hidden shadow-2xl">
                            <div
                        ...
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <div className="mt-12 flex flex-wrap justify-center gap-4">
                                {currentProduct.features.map((feature, idx) => (
                                    <span
                                        key={idx}
                                        className="px-6 py-3 rounded-full bg-white/10 border border-white/20 font-medium tracking-wide"
                                    >
                                        ✓ {feature}
                                    </span>
                                ))}
                    ...
                    >
                        <div className="bg-gradient-to-br from-white/10 to-transparent p-[1px] rounded-[3rem]">
                            <div className="bg-black/40 backdrop-blur-2xl p-12 md:p-20 rounded-[3rem]">
                                ...
                                <p className="text-xl opacity-70 mb-12 uppercase tracking-widest">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left border-t border-white/10 pt-12">
                                    <div>
                                        <h4 className="font-bold text-orange-400 mb-2 uppercase tracking-wide">
                                            Delivery Promise
                                        </h4>
                                    ...
                                    <div>
                                        <h4 className="font-bold text-pink-400 mb-2 uppercase tracking-wide">
