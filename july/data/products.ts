...
export const products: Product[] = [
    ...
    },
    {
        ...
        price: "₹850",
        description: "Fresh Blueberries - Vanilla Sponge - Cream Cheese Frosting",
        folderPath: "/images/cake1",
        themeColor: "#4A148C",
        gradient: "linear-gradient(135deg, #4A148C 0%, #311B92 100%)",
        features: ["Wild Blueberries", "Vanilla Sponge", "Cream Cheese"],
        stats: [{ label: "Fruit", val: "Fresh" }, { label: "Flavor", val: "Tangy" }, { label: "Colors", val: "Natural" }],
        section1: { title: "Blueberry Delight.", subtitle: "Berry luscious." },
        section2: { title: "A burst of blue.", subtitle: "Delicate vanilla sponge layered with wild blueberry compote and tangy cream cheese frosting." },
        section3: { title: "Perfectly balanced.", subtitle: "The tartness of blueberries perfectly complements our signature sweet frosting." },
        section4: { title: "An unforgettable treat.", subtitle: "" },
        detailsSection: {
            title: "Berry Perfection",
            description: "We source the finest wild blueberries to create our house-made compote, ensuring every bite is bursting with natural flavor. Paired with our velvety cream cheese frosting and soft vanilla sponge, it's a beautifully balanced dessert.",
            imageAlt: "Blueberry Cake Details"
        },
        freshnessSection: {
            title: "Crafted with Care",
            description: "To maintain the vibrant color and fresh taste of the blueberries, our compote is made in small batches. The cake is assembled fresh to order, guaranteeing perfect texture and flavor in every slice."
        },
        buyNowSection: {
            price: "₹850",
            unit: "per 500g cake",
            processingParams: ["Wild Blueberries", "Cream Cheese", "Eggless Option"],
            deliveryPromise: "Delivered fresh and chilled in secure packaging.",
            returnPolicy: "Not fully satisfied? Let us know and we'll make it right."
        }
    }
];
